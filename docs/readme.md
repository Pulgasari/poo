...
[`Date`](types.md#date)
[`Enum`](types.md#enum)
[`Generator`](types.md#generator)
[`List`](types.md#list)
[`Map`](types.md#map)
[`Number`](types.md#number) 
[`Pattern`](types.md#pattern)
[`Queue`](types.md#queue)
[`Record`](types.md#record)
[`RegExp`](types.md#regexp)
[`Set`](/types.md#set)
[`Stack`](types.md#stack)
[`String`](types.md#string)
[`Store`](types.md#store)
[`Symbol`](types.md#symbol)
[`Tree`](types.md#tree) 
[`Tuple`](types.md#tuple) 
[`Union`](types.md#union)

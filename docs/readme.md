...
[`Enum`](/docs/types.md#enum)
[`Generator`](/docs/types.md#generator)
[`List`](/docs/types.md#list)
[`Map`](/docs/types.md#map)
[`Number`](/docs/types.md#number) 
[`Pattern`](/docs/types.md#pattern)
[`Queue`](/docs/types.md#queue)
[`Record`](/docs/types.md#record)
[`RegExp`](/docs/types.md#regexp)
[`Set`](/docs/types.md#set)
[`Stack`](/docs/types.md#stack)
[`String`](/docs/types.md#string)
[`Store`](/docs/types.md#store)
[`Symbol`](/docs/types.md#symbol)
[`Tree`](/docs/types.md#tree) 
